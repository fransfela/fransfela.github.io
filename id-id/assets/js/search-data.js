...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/blog/id-id/";
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/about/";
          },
        },{id: "nav-blog",
          title: "Blog",
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/blog/";
          },
        },{id: "nav-publications",
          title: "Publications",
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/publications/";
          },
        },{id: "nav-projects",
          title: "Projects",
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/projects/";
          },
        },{id: "nav-zettelkasten",
          title: "Zettelkasten",
          ...
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/zettelkasten/";
          },
        },{id: "nav-cv",
          title: "CV",
          description: "",
          section: "Navigation menu",
          handler: () => {
            window.location.href = "/blog/id-id/cv/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2026/mentoring-bang-randy-scholarship-guidance/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2025/audio-quality-metrics-reference/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2025/book-soundscape-analysis/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2024/megatrends-sound-industry-workshop-reflection/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2024/optimal-clustering-part3-alternative-approaches/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2024/optimal-clustering-part2-advanced-statistical-methods/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2024/optimal-clustering-part1-foundation-methods/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/id-id/blog/2023/danish-sound-day-health-wellbeing-reflection/";
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/blog/id-id/books/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/blog/id-id/news/announcement_miho_defense/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/blog/id-id/news/announcement_phc_nusantara/";
            },},{id: "news-winner-of-microsoft-power-platform-hackathon-2024",
          title: 'Winner of Microsoft Power Platform Hackathon 2024',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/blog/id-id/news/announcement_microsoft_hackathon_winner/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/blog/id-id/news/announcement_rucha_defense/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/blog/id-id/projects/batchmailer/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/blog/id-id/projects/hoassr_dataset/";
            },},{
        id: 'social-email',
        title: 'Send an email',
        section: 'Socials',
        ...
        handler: () => {
          ...
          section: 'Languages',
          handler: () => {
            window.location.href = "/blog/" + updatedUrl;
          },
        },{
      id: 'light-theme',
