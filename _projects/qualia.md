...
img: assets/img/projects/qualia-thumb.png
importance: 1
category: work
...
<style>
  ...
  .qp-hero { display:flex; align-items:flex-start; gap:2rem; margin-bottom:2.5rem; }
  .qp-hero-text { flex:1; }
  .qp-title { font-size:22px; font-weight:500; color:var(--color-text-primary); margin:0 0 0.4rem; }
  .qp-subtitle { font-size:13px; font-weight:400; color:var(--color-text-secondary); margin:0 0 1rem; letter-spacing:0.04em; text-transform:uppercase; }
  .qp-desc { font-size:15px; line-height:1.75; color:var(--color-text-secondary); margin:0 0 1rem; }
  .qp-badges { display:flex; flex-wrap:wrap; gap:6px; margin-bottom:1.2rem; }
  ...
  .qp-ecosystem { background:var(--color-background-secondary); border:1px solid var(--card-border); border-radius:var(--radius); padding:1.2rem 1.4rem; margin-bottom:2rem; }
  .qp-ecosystem-title { font-size:12px; font-weight:500; color:var(--color-text-tertiary); text-transform:uppercase; letter-spacing:0.06em; margin:0 0 0.8rem; }
  .qp-pipeline { display:flex; align-items:center; gap:0; flex-wrap:wrap; }
  .pipe-node { display:flex; flex-direction:column; padding:8px 14px; border-radius:8px; border:1px solid var(--card-border); background:var(--color-background-primary); min-width:90px; }
  ...
  .pipe-sub { font-size:11px; color:var(--color-text-tertiary); margin-top:2px; }
  .pipe-arrow { font-size:16px; color:var(--color-text-tertiary); padding:0 8px; }
  ...
  .qp-rationale { background:var(--color-background-secondary); border-left:3px solid var(--teal); border-radius:0 var(--border-radius-md) var(--border-radius-md) 0; padding:1rem 1.2rem; margin-bottom:2rem; }
  .qp-rationale p { font-size:14px; line-height:1.7; color:var(--color-text-secondary); margin:0 0 0.6rem; }
  .qp-rationale p:last-child { margin:0; }
</style>
...
<div class="qp-wrap">
  ...
  <div class="qp-hero-text">
    <p class="qp-subtitle">GN Audio / Jabra &middot; Internal Research Tool</p>
      ...
      <div class="tool-header">
        <div class="tool-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="6" y1="30" x2="6" y2="30" stroke="#1D9E75" stroke-width="1"/>
            ...
            <!-- Right ear curve (teal) -->
            <polyline points="6,14 12,16 18,20 24,22 30,18 34,22"
              fill="none" stroke="#1D9E75" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <!-- Circle markers right -->
            ...
            <!-- Left ear curve (amber) -->
            <polyline points="6,17 12,19 18,24 24,27 30,23 34,26"
              fill="none" stroke="#EF9F27" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="2 1.5"/>
      ...
      <div class="tool-header">
        <div class="tool-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Tumbling-E rows, decreasing size -->
            <!-- Row 1 (largest) -->
      ...
      <div class="tool-header">
        <div class="tool-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Hidden numeral dots (teal/green-ish, forming "6") -->
      ...
      <div class="tool-header">
        <div class="tool-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Staircase convergence chart below -->
            <polyline points="4,37 8,34 12,37 16,34 20,35 24,33 28,34 32,33 36,33"
              fill="none" stroke="#1D9E75" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div class="tool-header">
        <div class="tool-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Left frame: clean (simple scene lines) -->
            ...
            <!-- Right frame: compression artifacts (block grid) -->
            ...
            <!-- CRF threshold meter (descending staircase) -->
            <text x="3" y="25" font-size="3.5" fill="#FAC775" font-family="monospace" opacity="0.7">CRF</text>
            <polyline points="8,35 10,30 14,35 18,30 22,32 26,28 30,29 34,28"
              fill="none" stroke="#EF9F27" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
